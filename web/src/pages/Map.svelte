<script lang="ts">
    ...
    function createMarker(
        ...
        return L.marker(toMapLatLng(coords) as any, {
            icon: makeTrackIcon(kind, heading, patrolColor, cached),
        ...
        try {
            ...
            for (const bodycam of bodycams || []) {
                ...
                if (existing) {
                    ...
                    existing.setIcon(makeTrackIcon("bodycam", bodycam.heading, color));
    ...
    // IDENTICAL to original onMount – no changes
    onMount(() => {
            ...
            <div class="panel" class:panel--open={officersOpen} class:panel--closed={!officersOpen}>
                ...
                <div class="panel-content panel-officers-content">
                    ...
                    {:else if totalVisibleOfficers === 0}
                        <div class="empty-hint">No officers match "{officerSearch}".</div>
                    {/if}
