...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    const { vehicles, tags, gallery, convictions, incidents, properties } =
      result;
    ...
    $(".manage-profile-pic").attr(
      "src",
      result["profilepic"] ?? "img/male.png"
    );
  ...
  $(".manage-bolos-title-holder").on("click", ".manage-bolos-new", function () {
    ...
    if ($(".badge-logo").attr("src") == "img/ems_badge.webp") {
      template = '<p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">ICU Room #: <em>[ # ]</em></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;"><br></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">Report ID: <em>[ Report ID ]</em></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;"><br></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">Time Admitted:<em> [ Date and Time Here ]</em></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">Surgery: <em>[Yes/No]</em></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;"><br></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">Injuries/Ailments:</span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;"> - [ Enter List Of Injuries Here ]</span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;"><br></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">Additional Attending:</span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">- <em>[ List Any Other Staff Here ]</em></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;"><br></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">🧑‍🤝‍🧑 Additional Emergency Contacts:</span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">- <em>[ Name And Number ]</em></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;"><br></span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;">Notes:</span></p><p style="line-height: 19px;"><span style="color: rgb(255, 255, 255); font-family: &quot;Times New Roman&quot;, Times, serif;"><em>[Additional Notes Here]</em></span></p>'
    }
    ...
    if (eventData.type == "show") {
      if (eventData.enable == true) {
        ...
        if (
          ...
          $(".manage-profile-incidents-container").removeClass(
            "display_hidden"
          );
      ...
      $.each(table, function (index, value) {
        $(".respond-calls-responses").prepend(
          `<div class="respond-calls-response"> ${value["name"]} responded "${value["message"]
          }" - ${timeAgo(Number(value.time))}. </div>`
        );
      });
                      ...
                      <div style="display: flex; flex-direction: column;">
                          <div class="profile-item-title">${name}</div>
                              ...
                              <div class="profile-criminal-tags">
                                  <span class="license-tag ${warrant}">${value.warrant ? "Active" : "No"
      } Warrant</span>
                                  <span class="license-tag ${convictions}">${value.convictions
      } Convictions </span>
                              </div>
                          </div>
                          <div class="profile-bottom-info">
                              <div class="profile-id"><span class="fas fa-id-card"></span> Citizen ID: ${value.citizenid
      }</div>&nbsp;
                          </div>
                      </div>
                  </div>
