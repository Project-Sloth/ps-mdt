...
INSERT IGNORE INTO `mdt_cameras` ( `cam_id` , `cam_label` , `cam_type` , `model` , `coords` , `rotation` , `image` , `can_rotate` , `is_online` , `spawns_model` , `created_at` , `created_by` , `feed_coords` , `feed_rotation` , `feed_fov` ) VALUES
('24701', '24/7 Innocence Blvd', 'store', 'security_cam_03', '{"x":23.88500022888183,"z":31.67200088500976,"y":-1342.4410400390626}', '{"x":-35.0,"z":-142.91909790039063,"y":0.0}', 'https://files.fivemerr.com/images/ca78a638-f17a-4456-9061-1648b593e394.png', 1, 1, 0, '2026-04-18 00:59:57', 'SYSTEM', '{"x":34.39834594726562,"z":31.7113094329834,"y":-1348.7598876953126}', '{"x":-21.29133796691894,"z":48.79743957519531,"y":0.0}', 71),
